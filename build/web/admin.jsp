            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a id="profile" href="profile.html"><span class="glyphicon glyphicon glyphicon-user"></span>
                        Profile</a></li>
                    <li class="my-active"><a id="admin" href="admin.html"><span class="glyphicon glyphicon glyphicon-cog"></span>
                        Admin</a></li>
                ...
                <div class="child">
                    ...
                    <table class="table">
                        ...
                        <tr class="danger">
                            ...
                            <td>Oct 13rd, 2016</td>
                            <td>Late</td>
                            <td><button class="btn btn-default btn-sm" data-toggle="modal" data-target="#send-mail">
...
<div class="modal" id="send-mail">
    <div class="modal-dialog modal-md black-border">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <form onsubmit="setTimeout(function () { window.location.reload(); }, 10)" id="send-mail-form">
                        <div class="input-group">
                            <span class="glyphicon input-group-addon glyphicon-envelope" ></span>
                            <input type="email" class="form-control X" placeholder="Email..." required/>
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            <span class="glyphicon input-group-addon glyphicon-pencil" ></span>
                            <textarea class="high" required placeholder="Message..."></textarea>
                        </div>
                    </form>
                </div>
            </div>
